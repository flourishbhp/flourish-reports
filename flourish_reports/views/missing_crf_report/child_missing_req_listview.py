...
class ChildMissingReqListView(NavbarViewMixin,
                              EdcBaseViewMixin,
                              ListboardFilterViewMixin,
                              MissingCRFListViewMixin,
                              ListboardView):

    listboard_template = 'missing_req_listboard_template'
    listboard_url = 'child_missing_req_report_url'
    ...
    crf_metadata_model = 'edc_metadata.requisitionmetadata'
